...
..'\n'
..'\n- VST plugin preset settings (not easily done)'
..'\n      > export/import .fxp files manually'
..'\n'
..'\n- Live native plugins and devices, including Racks'
...
..'\n      > consolidate them or render them to audio before attempting import again'
..'\n'
...
..'\n      > will be listen in Console, commit grooves before re-attempting import'
..'\n'
...
function getFXSlotBypassParameterNumber(given_Track,given_FXindex)
	...
	--local WetParNum = numberOfParameters-1 --should be Wet
	local BypassParNum = numberOfParameters-2 --should be Bypass
	...
	then
		ShowConsoleMsg_and_AddtoLog('\n WARNING: Bypass parameter not found: Parameter Number'..i..', currentParamName:'.. currentParamName)
	end
...
function getFXSlotWetParameterNumber(given_Track,given_FXindex)
	...
	then
		ShowConsoleMsg_and_AddtoLog('\n WARNING: Wet parameter not found: Parameter Number'..i..', currentParamName:'.. currentParamName)
	end
...
--- EQ Q WORK IN PROGRESS !!!!!!!!!!							
							...
							then
								...
								--------------------------------------------------------------
								-- ReaEQ:			"min": 4, 	def 	2.0, 	"max":	0.1
								-- Auto Filter: 	min: 0, 	"def": 	0.14 	max: 	1.25
								...
								if Event_Value < 0.01 then Event_Value = 0.01 end
...
--*********************************************************************************
-- useDataFrom_Eq8DeviceXMLTable2
--*********************************************************************************

function useDataFrom_Eq8DeviceXMLTable2(
...
end--function useDataFrom_Eq8DeviceXMLTable2
...
--****************************************************
-- useDataFrom_AutoFilterDeviceXMLTable
--****************************************************
function useDataFrom_AutoFilterDeviceXMLTable(
											given_PluginDeviceXMLTable,
											given_RPRtrack,
											given_AutomationEnvelopesXMLTable
											)
											
	--reaper.ShowConsoleMsg('\n\nSTARTING function useDataFrom_AutoFilterDeviceXMLTable')
...
end--function useDataFrom_AutoFilterDeviceXMLTable
...
--*********************************************************************************
-- useDataFrom_ReverbDeviceXMLTable
--*********************************************************************************

function useDataFrom_ReverbDeviceXMLTable(
...
end--function useDataFrom_ReverbDeviceXMLTable



--*********************************************************************************
-- useDataFrom_CrossDelayDeviceXMLTable
--*********************************************************************************
...
function useDataFrom_CrossDelayDeviceXMLTable(
						given_PluginDeviceXMLTable,				-- given_PluginDeviceXMLTable,
						given_RPRtrack,							-- given_RPRtrack
						given_AutomationEnvelopesXMLTable		-- given_AutomationEnvelopesXMLTable
						)
...
end--function useDataFrom_CrossDelayDeviceXMLTable
...
--*********************************************************************************
-- useDataFrom_PingPongDelayDeviceXMLTable
--*********************************************************************************
...
function useDataFrom_PingPongDelayDeviceXMLTable(
						given_PluginDeviceXMLTable,			-- given_PluginDeviceXMLTable,
						given_RPRtrack,						-- given_RPRtrack
						given_AutomationEnvelopesXMLTable	-- given_AutomationEnvelopesXMLTable
						)
...
end--function useDataFrom_PingPongDelayDeviceXMLTable
...
--*********************************************************
-- useDataFrom_GateDeviceXMLTable
--*********************************************************
function useDataFrom_GateDeviceXMLTable(
								given_PluginDeviceXMLTable,
								given_RPRtrack,
								given_AutomationEnvelopesXMLTable
								)
	...
	then
		...
		reaper.TrackFX_SetParam(given_RPRtrack,currentFXindex,
								getParNumBy_1stParNameInPNPMTable(PARNUM_PARNAME_TABLE,'Thresh'),(Threshold_ManVal))
		checkAndAdd_FXPlugEnv_by_AuTargId_and_FXParNum(given_RPRtrack,currentFXindex,Threshold_AuTargId,	-- given_AutomationTargetId,
								getParNumBy_1stParNameInPNPMTable(PARNUM_PARNAME_TABLE,'Thresh'),			-- given_PluginParameterNumber,
								given_AutomationEnvelopesXMLTable,											-- given_AutomationEnvelopesXMLTable
								''	)																		-- ENVELOPE_POINT_UNIT
		...
		-- <Gain> / Floor? NOTE: Live Out Gain range: -36 to +36; ReaComp Wet range -inf to +12: 
		--reaper.TrackFX_SetParam(given_RPRtrack,currentFXindex,
		...
		reaper.TrackFX_SetParam(given_RPRtrack,currentFXindex,
								getParNumBy_1stParNameInPNPMTable(PARNUM_PARNAME_TABLE,'PreviewF'),SideListen_ManVal)				
		checkAndAdd_FXPlugEnv_by_AuTargId_and_FXParNum(given_RPRtrack,currentFXindex,SideListen_AuTargId,	-- given_AutomationTargetId,
							getParNumBy_1stParNameInPNPMTable(PARNUM_PARNAME_TABLE,'PreviewF'),				-- given_PluginParameterNumber,
							given_AutomationEnvelopesXMLTable,												-- given_AutomationEnvelopesXMLTable
...
-- WORK IN PROGRESS NOTE: MAKE SURE THIS IS ACTUALLY THE SAME THING IN BOTH Live and ReaGate
		...
		reaper.TrackFX_SetParam(given_RPRtrack,currentFXindex,
								getParNumBy_1stParNameInPNPMTable(PARNUM_PARNAME_TABLE,'InvrtWet'),FlipMode_ManVal)
		checkAndAdd_FXPlugEnv_by_AuTargId_and_FXParNum(given_RPRtrack,currentFXindex,FlipMode_AuTargId,	-- given_AutomationTargetId,
								getParNumBy_1stParNameInPNPMTable(PARNUM_PARNAME_TABLE,'InvrtWet'),		-- given_PluginParameterNumber,
								given_AutomationEnvelopesXMLTable,										-- given_AutomationEnvelopesXMLTable
...
end--function useDataFrom_GateDeviceXMLTable
...
--*********************************************************
-- useDataFrom_Compressor2DeviceXMLTable
--*********************************************************
function useDataFrom_Compressor2DeviceXMLTable(
												given_PluginDeviceXMLTable,
												given_RPRtrack,
												given_AutomationEnvelopesXMLTable
												)
	...
	then
		...
		reaper.TrackFX_SetParam(given_RPRtrack,currentFXindex,
								getParNumBy_1stParNameInPNPMTable(PARNUM_PARNAME_TABLE,'AutoRel'),AutoReleaseControlOnOff_ManVal)
		checkAndAdd_FXPlugEnv_by_AuTargId_and_FXParNum(given_RPRtrack,currentFXindex,AutoReleaseControlOnOff_AuTargId,	-- given_AutomationTargetId,
								getParNumBy_1stParNameInPNPMTable(PARNUM_PARNAME_TABLE,'AutoRel'),						-- given_PluginParameterNumber,
								given_AutomationEnvelopesXMLTable,														-- given_AutomationEnvelopesXMLTable
		...
		reaper.TrackFX_SetParam(given_RPRtrack,currentFXindex,
								getParNumBy_1stParNameInPNPMTable(PARNUM_PARNAME_TABLE,'AutoMkUp'),GainCompensation_ManVal)						
		checkAndAdd_FXPlugEnv_by_AuTargId_and_FXParNum(given_RPRtrack,currentFXindex,GainCompensation_AuTargId,	-- given_AutomationTargetId,
								getParNumBy_1stParNameInPNPMTable(PARNUM_PARNAME_TABLE,'AutoMkUp'),				-- given_PluginParameterNumber,
								given_AutomationEnvelopesXMLTable,												-- given_AutomationEnvelopesXMLTable
	...
	do
			...
			then
				...
				do
					...
					then
						...
						--printTableToConsole(currentPresetBufferTable,'currentPresetBufferTable')-- given_Table,given_TableName
						break
		...
		then
			...
			do
				...
				--Live_PluginPresetBinaryData = Live_PluginPresetBinaryData..currentPresetBufferTable[kj]
...
--*********************************************************
-- useDataFrom_OriginalSimpler_XMLTable
--*********************************************************
function useDataFrom_OriginalSimpler_XMLTable(
								given_PluginDeviceXMLTable,
								given_RPRtrack,
								given_AutomationEnvelopesXMLTable
								)
...
end--function useDataFrom_OriginalSimpler_XMLTable
...
--*********************************************************
-- useDataFrom_MultiSampler_XMLTable
--*********************************************************
function useDataFrom_MultiSampler_XMLTable(
								given_PluginDeviceXMLTable,
								given_RPRtrack,
								given_AutomationEnvelopesXMLTable
								)
...
end--function useDataFrom_MultiSampler_XMLTable
...
function startParsingLiveSetXML(given_LiveSetXMLTable)
	...
	..'\n'
	..'\nThis is necessary so that REAPER can format and check the imported data, and notify of any problems.'
	..'\n'
	...
	then
		local askToSaveLog = reaper.ShowMessageBox("There were warnings during import. \n\nSave a log file into same directory as selected un-gzipped project file?", "Warnings detected - save log?", 1)
